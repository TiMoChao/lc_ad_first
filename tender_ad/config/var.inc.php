<?php
/**
 * 广告招标功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'tender_ad';
$arrGPdoDB['db_table1'] = 'tender_ad_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '广告招标';
$arrGWeb['module_id'] = 'tender_ad';
$arrGWeb['cache_tender_ad_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
