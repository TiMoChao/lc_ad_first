...
define('p',chr(66).chr(73).chr(87).chr(69).chr(66).chr(32).chr(86).chr(53).chr(46).chr(56));
 ...
 */
     ...
     * @param string $compile_id
     */
    function display($resource_name, $cache_id = null, $compile_id = null,$display = true)
    {
        $this->fetch($resource_name, $cache_id, $compile_id, $display);
    }
