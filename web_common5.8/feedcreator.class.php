...
class FeedCreator extends HtmlDescribable {
	...
	*/
	...
	function _createStylesheetReferences() {
		$xml = "";
		if (!empty($this->cssStyleSheet) && $this->cssStyleSheet) $xml .= "<?xml-stylesheet href=\"".$this->cssStyleSheet."\" type=\"text/css\"?>\n";
		if (!empty($this->xslStyleSheet) && $this->xslStyleSheet) $xml .= "<?xml-stylesheet href=\"".$this->xslStyleSheet."\" type=\"text/xsl\"?>\n";
		return $xml;
	}
