<?php
/**
 * 候车亭广告功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'shelter_ad';
$arrGPdoDB['db_table1'] = 'shelter_ad_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '候车亭广告';
$arrGWeb['module_id'] = 'shelter_ad';
$arrGWeb['cache_shelter_ad_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
