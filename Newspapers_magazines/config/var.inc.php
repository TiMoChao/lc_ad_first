<?php
/**
 * 报纸杂志功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'Newspapers_magazines';
$arrGPdoDB['db_table1'] = 'Newspapers_magazines_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '报纸杂志';
$arrGWeb['module_id'] = 'Newspapers_magazines';
$arrGWeb['cache_Newspapers_magazines_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
