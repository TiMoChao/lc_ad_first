...
*/
$arrGPdoDB['db_table'] = 'video';
$arrGPdoDB['db_table1'] = 'video_type';
$arrGPdoDB['db_table_field']=array('id'=>'','type_id'=>1,'type_roue_id'=>'','user_id'=>1,'tag'=>'','bedeck'=>0,'title'=>'','title_md5'=>'','linkurl'=>'','summary'=>'','structon_tb'=>array('meta_Title','meta_Description','meta_Keywords','author','intro','photo','photo_narrate','video_link','video'),'thumbnail'=>'','submit_date'=>date('Y-m-d H:i:s'),'topflag'=>0,'recommendflag'=>0,'stars'=>0,'clicktimes'=>0,'pass'=>1);   //字段数组，将要显示的字段名称写入该数组
$arrGPdoDB['htmlspecialchars'] = array('intro','summary','tag');

//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '行业视频';
$arrGWeb['module_id'] = 'video';
$arrGWeb['cache_news_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
