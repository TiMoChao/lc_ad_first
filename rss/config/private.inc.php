...
//权限控制参数
$arrMPopedom = array();
$arrMPopedom['list_check'] = '0'; //1开启检查，0关闭检查
$arrMPopedom['detail_check'] = '0';
$arrMPopedom['super_user'] = 'root';		// 超管帐号
$arrMPopedom['type_read_grade'] = '0';	// 默认浏览所需星级
$arrMPopedom['type_write_grade'] = '0';	// 默认在栏目发栏目文章所需星级
?>