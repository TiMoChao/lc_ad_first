<?php
/**
 * 小区广告功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'Community_ad';
$arrGPdoDB['db_table1'] = 'Community_ad_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '小区广告';
$arrGWeb['module_id'] = 'Community_ad';
$arrGWeb['cache_Community_ad_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
