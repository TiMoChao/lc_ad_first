<?php /* Smarty version 2.6.20, created on 2015-06-04 15:34:56
         compiled from Personality_customization/block/search.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'Personality_customization/block/search.html', 3, false),)), $this); ?>
<DIV id="menu">
	<DIV class="menu_l">
...
/Personality_customization/search.php" method="get"><INPUT class="butt_a" id="keywords" name="keywords" value="<?php echo $_GET['keywords']; ?>
