<?php /* Smarty version 2.6.20, created on 2015-10-26 18:29:04
         compiled from /Volumes/data/chao_program/lc_ad_first/Newspapers_magazines/config/../../templates/1/Newspapers_magazines/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', '/Volumes/data/chao_program/lc_ad_first/Newspapers_magazines/config/../../templates/1/Newspapers_magazines/index.html', 10, false),array('modifier', 'csubstr', '/Volumes/data/chao_program/lc_ad_first/Newspapers_magazines/config/../../templates/1/Newspapers_magazines/index.html', 15, false),array('modifier', 'date_format', '/Volumes/data/chao_program/lc_ad_first/Newspapers_magazines/config/../../templates/1/Newspapers_magazines/index.html', 16, false),)), $this); ?>
...
<div class="block7"></div>
		...
		<?php $_from = $this->_tpl_vars['arrTopNewspapers_magazines']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
