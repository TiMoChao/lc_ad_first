<?php /* Smarty version 2.6.20, created on 2015-10-26 18:27:36
         compiled from multimedia_ad/block/top_index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'multimedia_ad/block/top_index.html', 6, false),array('modifier', 'csubstr', 'multimedia_ad/block/top_index.html', 6, false),array('modifier', 'date_format', 'multimedia_ad/block/top_index.html', 8, false),)), $this); ?>
	
					<?php $_from = $this->_tpl_vars['arrTopmultimedia_ad1']['0']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php else: ?><?php echo smarty_function_url(array('url' => "/multimedia_ad/detail.php?id=".($this->_tpl_vars['arrData']['id']),'cache' => ($this->_tpl_vars['arrGWeb']['file_static'])), $this);?>
