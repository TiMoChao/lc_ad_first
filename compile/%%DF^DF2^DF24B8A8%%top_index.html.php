...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'outdoor_ad/block/top_index.html', 7, false),array('modifier', 'csubstr', 'outdoor_ad/block/top_index.html', 7, false),array('modifier', 'date_format', 'outdoor_ad/block/top_index.html', 9, false),)), $this); ?>
					...
					<?php $_from = $this->_tpl_vars['arrTopoutdoor_ad1']['0']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php else: ?><?php echo smarty_function_url(array('url' => "/outdoor_ad/detail.php?id=".($this->_tpl_vars['arrData']['id']),'cache' => ($this->_tpl_vars['arrGWeb']['file_static'])), $this);?>
