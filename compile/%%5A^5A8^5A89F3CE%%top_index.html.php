...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'car_ad/block/top_index.html', 6, false),array('modifier', 'csubstr', 'car_ad/block/top_index.html', 6, false),array('modifier', 'date_format', 'car_ad/block/top_index.html', 8, false),)), $this); ?>
					...
					<?php $_from = $this->_tpl_vars['arrTopcar_ad1']['0']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php else: ?><?php echo smarty_function_url(array('url' => "/car_ad/detail.php?id=".($this->_tpl_vars['arrData']['id']),'cache' => ($this->_tpl_vars['arrGWeb']['file_static'])), $this);?>
