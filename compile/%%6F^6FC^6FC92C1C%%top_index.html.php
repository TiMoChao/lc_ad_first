<?php /* Smarty version 2.6.20, created on 2015-10-26 18:27:37
         compiled from Planning_production/block/top_index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'Planning_production/block/top_index.html', 7, false),array('modifier', 'csubstr', 'Planning_production/block/top_index.html', 7, false),array('modifier', 'date_format', 'Planning_production/block/top_index.html', 9, false),)), $this); ?>


						<?php $_from = $this->_tpl_vars['arrTopPlanning_production1']['0']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php else: ?><?php echo smarty_function_url(array('url' => "/Planning_production/detail.php?id=".($this->_tpl_vars['arrData']['id']),'cache' => ($this->_tpl_vars['arrGWeb']['file_static'])), $this);?>
