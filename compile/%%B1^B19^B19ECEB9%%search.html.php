<?php /* Smarty version 2.6.20, created on 2015-06-04 15:58:18
         compiled from Planning_production/block/search.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'Planning_production/block/search.html', 3, false),)), $this); ?>
<DIV id="menu">
	<DIV class="menu_l">
...
/Planning_production/search.php" method="get"><INPUT class="butt_a" id="keywords" name="keywords" value="<?php echo $_GET['keywords']; ?>
