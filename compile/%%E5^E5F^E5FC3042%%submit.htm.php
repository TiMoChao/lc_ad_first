<?php /* Smarty version 2.6.20, created on 2015-06-04 15:46:10
         compiled from C:%5CProgram+Files+%28x86%29%5CZend%5CApache2%5Chtdocs%5Clc_ad%5Ctender_ad%5Cconfig/../../tender_ad/admin/templats/submit.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'C:\\Program Files (x86)\\Zend\\Apache2\\htdocs\\lc_ad\\tender_ad\\config/../../tender_ad/admin/templats/submit.htm', 100, false),array('modifier', 'stripslashes', 'C:\\Program Files (x86)\\Zend\\Apache2\\htdocs\\lc_ad\\tender_ad\\config/../../tender_ad/admin/templats/submit.htm', 100, false),)), $this); ?>
...
" <?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['arrData']['type_id']): ?>selected=selected<?php endif; ?>><?php echo $this->_tpl_vars['type']; ?>
    ...
    <td><font color="red">*</font><span class=gray>广告招标分类</span></td></tr>
  <tr>
  	<td>广告招标标题：</td>
...
"></td>
	...
	<tr>
    <td>手机：</td>
    <td><input name=diliweizhimiaoshu maxLength=210 size=55 value="<?php echo $this->_tpl_vars['arrData']['diliweizhimiaoshu']; ?>
"></td>
    <td><span class=gray></span></td></tr>
	 <tr>
    <td>联系电话：</td>
