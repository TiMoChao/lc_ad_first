...
">首页</A><?php if ($this->_tpl_vars['strTypeTitle'] != ''): ?> &gt; <?php echo $this->_tpl_vars['strTypeTitle']; ?>
...
/tender_ad/search.php" method="get"><INPUT class="butt_a" id="keywords" name="keywords" value="<?php echo $_GET['keywords']; ?>
