<?php /* Smarty version 2.6.20, created on 2015-06-04 15:07:08
         compiled from login.htm */ ?>
<html><head><title><?php echo $this->_tpl_vars['arrGWeb']['name']; ?>
管理后台</title>
...
<table cellSpacing=0 cellPadding=0 width="100%" bgColor=#003399 border=0>
  <tbody>
  <tr height=40>
    <td vAlign=center><a href="<?php echo $this->_tpl_vars['arrGWeb']['WEB_ROOT_pre']; ?>
"></a></td>
    <td class=maindesc align=right width=400><a class=topbar 
      href="<?php echo $this->_tpl_vars['arrGWeb']['WEB_ROOT_pre']; ?>
">Contact us with any 
      questions</a>&nbsp;&nbsp; </td></tr></tbody></table><br><br><span 
class=windowheader>
<CENTER><a href="<?php echo $this->_tpl_vars['arrGWeb']['WEB_ROOT_pre']; ?>
"><b><?php echo $this->_tpl_vars['arrGWeb']['name']; ?>
          ...
          <td class=maindesc align=middle><br>Enter your username and password 
            ...
            bgColor=#f5f5f5 border=0>
			  ...
			  <tr>
                ...
                <td><input onkeypress="return enter(this, event);" 
                  type=text value="" name=authCode size=6> ←<img src="<?php echo $this->_tpl_vars['strAuthImgDir']; ?>
" align='top'></td></tr>				  
              <tr>
...
<P class=maindesc><a href="<?php echo $this->_tpl_vars['arrGWeb']['WEB_ROOT_pre']; ?>
" target="_blank">广告信息业务网站系统</a></P><br><br>
<div class=maindesc align=center>Copyright © 2015-2015 广告信息网, All Rights Reserved .</div></td></tr></table><br></CENTER></body></html>