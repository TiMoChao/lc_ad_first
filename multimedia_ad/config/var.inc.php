<?php
/**
 * 多媒体功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'multimedia_ad';
$arrGPdoDB['db_table1'] = 'multimedia_ad_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '多媒体';
$arrGWeb['module_id'] = 'multimedia_ad';
$arrGWeb['cache_multimedia_ad_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
