...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	if (empty($_POST['type_id'])||empty($_POST['title'])||empty($_POST['intro'])||empty($_POST['company_code'])||empty($_POST['free_tel'])||empty($_POST['company_tel'])||empty($_POST['company_fax'])||empty($_POST['company_address'])||empty($_POST['company_web'])||empty($_POST['main_product'])||empty($_POST['linkman'])){
