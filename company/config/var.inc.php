<?php
/**
 * 企业黄页功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'company';
$arrGPdoDB['db_table1'] = 'company_type';
$arrGPdoDB['db_table_field']=array('id'=>'','type_id'=>1,'type_roue_id'=>'','user_id'=>1,'tag'=>'','bedeck'=>0,'title'=>'','title_md5'=>'','linkurl'=>'','summary'=>'','structon_tb'=>array('meta_Title','meta_Description','meta_Keywords','intro','product','linkman','company_code','company_tel','company_fax','company_web','free_tel','company_address','main_product','photo','video','photo_narrate'),'city'=>'','province'=>'','area'=>'','thumbnail'=>'','submit_date'=>date('Y-m-d H:i:s'),'topflag'=>0,'recommendflag'=>0,'stars'=>0,'clicktimes'=>0,'pass'=>1); 
//字段数组，将要显示的字段名称写入该数组
$arrGPdoDB['htmlspecialchars'] = array('intro','summary','tag');

//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '企业黄页';
$arrGWeb['module_id'] = 'company';
$arrGWeb['cache_company_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
