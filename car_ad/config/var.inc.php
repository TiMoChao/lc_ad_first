<?php
/**
 * 车体广告功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'car_ad';
$arrGPdoDB['db_table1'] = 'car_ad_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '车体广告';
$arrGWeb['module_id'] = 'car_ad';
$arrGWeb['cache_car_ad_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
