...
if (is_object($objWebInit)) {
	...
	//echo $strWhere;
	$arrRelative = array();
	$arrRelative = $objjob->getInfoList($strWhere." and pass=1 and id!=".$arrInfo['id']," ORDER BY clicktimes DESC,submit_date DESC,recommendflag DESC,clicktimes DESC", 0, 5,true);
