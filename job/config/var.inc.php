<?php
/**
 * 招聘信息功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'job';
$arrGPdoDB['db_table1'] = 'job_type';
$arrGPdoDB['db_table_field']=array('id'=>'','type_id'=>1,'type_roue_id'=>'','user_id'=>1,'tag'=>'','bedeck'=>0,'title'=>'','title_md5'=>'','linkurl'=>'','summary'=>'','structon_tb'=>array('meta_Title','meta_Description','meta_Keywords','author','intro','photo','photo_narrate','workexperience','educationrecord','num','salary','companyname','companyintro','contact'),'thumbnail'=>'','submit_date'=>date('Y-m-d H:i:s'),'topflag'=>0,'recommendflag'=>0,'stars'=>0,'clicktimes'=>0,'pass'=>1,'province'=>'','city'=>'','area'=>'');   //招聘信息数组
$arrGPdoDB['htmlspecialchars'] = array('intro','summary','tag');

//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '招聘信息';
$arrGWeb['module_id'] = 'job';
$arrGWeb['cache_job_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
