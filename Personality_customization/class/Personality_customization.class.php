...
class Personality_customization extends ArthurXF{
	public $thisModel = 'Personality_customization';
	...
	function makeInfoTypeListXML($strXML){
		...
		$objXML = new xml();
		if($arr = $this->getTypeList($arrData['Personality_customization_type_parentid'])){
