<?php
/**
 * 个性定制功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'Personality_customization';
$arrGPdoDB['db_table1'] = 'Personality_customization_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '个性定制';
$arrGWeb['module_id'] = 'Personality_customization';
$arrGWeb['cache_Personality_customization_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
