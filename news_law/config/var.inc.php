<?php
/**
 * 资讯功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'news_law';
$arrGPdoDB['db_table1'] = 'news_law_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '资讯';
$arrGWeb['module_id'] = 'news_law';
$arrGWeb['cache_news_law_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
