<?php
/**
 * 策划制作功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'Planning_production';
$arrGPdoDB['db_table1'] = 'Planning_production_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '策划制作';
$arrGWeb['module_id'] = 'Planning_production';
$arrGWeb['cache_Planning_production_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
