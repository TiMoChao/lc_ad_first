<?php
/**
 * 商展信息功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'product';
$arrGPdoDB['db_table1'] = 'product_type';
$arrGPdoDB['db_table_field']=array('id'=>'','type_id'=>1,'type_roue_id'=>'','user_id'=>1,'tag'=>'','bedeck'=>0,'title'=>'','title_md5'=>'','company_md5'=>'','linkurl'=>'','summary'=>'','structon_tb'=>array('title','author','model','brand','market_price','my_price','sendtime','summary','intro','power','fittings','options','certificate','company','contact','photo','video','photo_narrate'),'thumbnail'=>'','submit_date'=>date('Y-m-d H:i:s'),'topflag'=>0,'recommendflag'=>0,'stars'=>0,'clicktimes'=>0,'pass'=>1,'province'=>'','city'=>'','area'=>'',);   //字段数组，将要显示的字段名称写入该数组
$arrGPdoDB['htmlspecialchars'] = array('intro','summary','tag');

//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '商展信息';
$arrGWeb['module_id'] = 'product';
$arrGWeb['cache_product_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
